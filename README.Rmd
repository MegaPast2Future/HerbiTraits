...
## Load Data
herbitraits.data = read.xls(xls = "herbiTraits/herbiTraits_v1.0_final.xlsx", sheet = "Data", header = TRUE)

herbitraits.references =  read.xls(xls = "herbiTraits/herbiTraits_v1.0_final.xlsx", sheet = "References", header = TRUE)
...
# Using the data
HerbiTraits consists of an Excel spreadsheet containing metadata, the trait dataset, and references as three separate sheets. The dataset is open-access.
